...
public class DemoApplicationTest {
	private final AnnotationConfigApplicationContext appCtx = new AnnotationConfigApplicationContext(DemoApplication.class);
	@SuppressWarnings("unchecked")
	private final AtomicReference<CompletableFuture<Object>> ref1 = (AtomicReference<CompletableFuture<Object>>) this.appCtx.getBean("ref1");
