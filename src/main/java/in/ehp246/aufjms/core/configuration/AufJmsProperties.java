...
public class AufJmsProperties {
	public static final String TIMEOUT = "in.ehp246.aufjms.bymsg.timeout";
	public static final String TTL = "in.ehp246.aufjms.ttl";
	public static final String POOL_SIZE = "in.ehp246.aufjms.executor.poolSize";
